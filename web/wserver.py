...
# Redesigned By - @TheOnlyMrLucifer (https://github.com/SlamDevs/slam-mirrorbot/commit/1e572f4fa3625ecceb953ce6d3e7cf7334a4d542#diff-c3d91f56f4c5d8b5af3d856d15a76bd5f00aa38d712691b91501734940761bdd)
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/b9b3e76c4b930a6ec223e.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @TheOnlyMrLucifer-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/b9b3e76c4b930a6ec223e.jpg"
          alt="logo"
        />
        <a href="https://t.me/TheOnlyMrLucifer">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/TheOnlyMrLucifer/WikiLeaksGG2"><i class="fab fa-github"></i></a>
        <a href="https://t.me/TheOnlyMrLucifer"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See mirror-leech-telegram-bot <a href='https://github.com/TheOnlyMrLucifer/WikiLeaksGG2'>@GitHub</a> By <a href='https://github.com/TheOnlyMrLucifer'>TheOnlyMrLucifer</a></h1>"
