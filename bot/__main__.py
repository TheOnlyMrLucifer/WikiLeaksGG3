...
def start(update, context):
    ...
    buttons.buildbutton("WikiLeaks GateWay", "https://t.me/WikiLeaksGateWay")
...
'''
        ...
        sendMarkup('Not Authorized user, MSG Owner For Authorization @TheOnlyMrLucifer', context.bot, update.message, reply_markup)
...
help = telegraph.create_page(
        title='WikiLeaks Leech Bot Help',
