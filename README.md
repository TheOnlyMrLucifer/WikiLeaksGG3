...
- Clone this repo:
```
git clone https://github.com/TheOnlyMrLucifer/WikiLeaksGG2 mirrorbot/ && cd mirrorbot
```
...
**2. Optional Fields**
- `DATABASE_URL`: Your SQL Database URL. Follow this [Generate Database](https://github.com/TheOnlyMrLucifer/WikiLeaksGG2/tree/master#generate-database) to generate database. Data will be saved in Database: auth and sudo users, leech settings including thumbnails for each user, rss data and incomplete tasks. **NOTE**: If deploying on heroku and using heroku postgresql delete this variable from **config.env** file. **DATABASE_URL** will be grabbed from heroku variables.
...
- `USE_SERVICE_ACCOUNTS`: Whether to use Service Accounts or not. For this to work see [Using Service Accounts](https://github.com/TheOnlyMrLucifer/WikiLeaksGG2#generate-service-accounts-what-is-service-account) section below. Default is `False`. `Bool`
...
### GDTOT
- `CRYPT`: Cookie for gdtot google drive link generator. Follow these [steps](https://github.com/TheOnlyMrLucifer/WikiLeaksGG2/tree/master#gdtot-cookies).
...
**NOTE**: If you want to use port other than 80, change it in [docker-compose.yml](https://github.com/TheOnlyMrLucifer/WikiLeaksGG2/blob/master/docker-compose.yml) also.
...
## Deploying on Heroku
<p><a href="https://github.com/TheOnlyMrLucifer/WikiLeaksGG2/tree/heroku"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="170""/></a></p>
